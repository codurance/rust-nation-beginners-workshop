...
fn main() {
    ...
    //4 - Should work with different values
    ...
    //5 - Should place picked up items in inventory
    ...
    //6 - When eating a super star Mario should become invulnerable, and invalidate old player object
    ...
    //7 - given time has run out, invulnerable player becomes regular player, and invalidate
